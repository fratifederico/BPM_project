...
riga_casuale.to_csv("output/random_row.txt", sep="\t", index=False)
...
prompt = "Con le seguenti specifiche di prodotto, come valuteresti con un voto da 0 a 100 (rispondi solo col numero) " \
...
PROMPT = riga_casuale.to_string(index=False,header=False)
